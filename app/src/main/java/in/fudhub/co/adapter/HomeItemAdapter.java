...
import in.fudhub.co.extra.RecyclerTouchListener;
import in.fudhub.co.extra.SharedPreference;
import in.fudhub.co.model.CartItem;
import in.fudhub.co.model.ItemGetSet;
import in.fudhub.co.model.VariationGetSet;

import java.util.ArrayList;
import java.util.List;

public class HomeItemAdapter extends RecyclerView.Adapter<HomeItemAdapter.ProgramViewHolder> {
    int count = 0;
    ...
    public HomeItemAdapter(ArrayList<ItemGetSet> fooditem, Context context) {
    ...
    public ProgramViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.showproduct_details, viewGroup, false);

        return new ProgramViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ProgramViewHolder programViewHolder, @SuppressLint("RecyclerView") int i) {
...
//        ct=String.valueOf(favouritesBeanSampleList.size());
            ...
            DeshBoard.itemcounter.setText(Constants.cartitems);
